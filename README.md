...
**현재 상태:** 기본 기능 소스 작성, Core 검증 18개 통과, **Xcode 26.6에서 iPad 시뮬레이터용 Debug 빌드 성공**. 연속 PDF의 시뮬레이터 표시·렌더링·저장·내보내기를 검증했습니다. 긴 노트의 위·중간·아래에서 터치 필기 중 좌표 안정성을 UI 자동 검증했습니다. 세 손가락 제스처 및 실제 iPad의 Apple Pencil 입력은 추가 확인이 필요합니다. 서명된 `.ipa`는 포함하지 않습니다.
